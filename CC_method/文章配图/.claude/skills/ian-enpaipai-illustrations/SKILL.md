---
name: ian-enpaipai-illustrations
description: 生成 Ian 风格的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成"温暖手绘""嗯哌哌""手绘""正文配图""文章插图""配图建议""shot list""去标题/改图"等任务；默认使用嗯哌哌 IP、纯白手绘、温暖彩铅质感、少量红橙蓝批注、简洁清爽但温暖治愈的视觉风格。
---
...
为中文文章设计和生成 16:9 横版正文配图。目标不是做商业插画、PPT 信息图或冷冰冰的技术图表，而是把文章里的关键判断、流程、结构、状态或隐喻，变成一张温暖、俏皮、有创意、可读但不说明书的手绘解释图。

默认视觉 IP 是"嗯哌哌"：长直深色中分长发、白色宽松针织毛衣、大而有表现力的温暖眼睛、柔和手绘线条、彩铅或轻水彩质感。嗯哌哌必须参与画面的核心情感和视觉表达，用姿势、表情和手势传达观点，不能只是站在旁边当装饰。
...
- `references/enpaipai-ip.md`：嗯哌哌 IP 的形象、性格、动作库和禁忌。
...
- 16:9 横版中文正文配图
- 纯白背景
- 温暖手绘线稿（柔软铅笔/墨线 + 彩铅或轻水彩填充）
- 少量红色/橙色/蓝色中文手写批注
- 大量留白
- 嗯哌哌作为核心情感与视觉主体
- 禁止 PPT、商业插画、过度 Q 版、复杂架构、左上角类型标题

不要复刻过往案例。案例只提供风格密度和嗯哌哌参与方式，不能直接复用已有构图，除非用户明确要求复刻某张图。每次都要从当前文章重新发明一个温暖但成立的隐喻。
